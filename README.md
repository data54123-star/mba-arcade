...
3. Technische Umsetzung & Architektur
Die Applikation wurde konsequent als Progressive Web App (PWA) konzipiert. Dabei wurden folgende Kernkonzepte und Architekturentscheidungen umgesetzt:

Backend-as-a-Service & Hosting: Als Backend kommt Google Firebase zum Einsatz (Firestore für die synchrone Echtzeit-Datenbank und Firebase Auth für das User-Management). Das Frontend der Applikation wird komplett über GitHub Pages gehostet, was eine nahtlose und performante Auslieferung direkt aus dem Repository ermöglicht.
